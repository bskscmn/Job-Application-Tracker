    ...
    <jet-form-section @submitted="updatePassword">
        ...
        <template #form>
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="current_password" v-bind:value="__('Current Password')" />
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password" v-bind:value="__('New Password')" />
                <jet-input id="password" type="password" class="mt-1 block w-full" v-model="form.password" autocomplete="new-password" />
                <jet-input-error :message="form.error('password')" class="mt-2" />
            </div>

            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password_confirmation" v-bind:value="__('Confirm Password')" />
