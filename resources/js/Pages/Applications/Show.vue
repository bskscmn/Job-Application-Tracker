                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="container mx-auto p-4 divide-y divide-gray-200">
                        ...
                        <div class="mt-2 p-6">
                            ...
                            <div><span class="text-lg leading-7 text-gray-900 font-semibold">Location:</span> 
                                {{app.location}}
                            </div>
                			<div>
                                <span class="text-lg leading-7 text-gray-900 font-semibold">Post:</span> 
                                {{app.post_title}}
                            </div>
                            <div class="mt-2">
                                <span class="text-lg leading-7 text-gray-900 font-semibold">Link:</span> 
                                <a :href=app.link target="_blank" class="underline text-teal-900 dark:text-white">{{app.link}}</a>
                            </div>
