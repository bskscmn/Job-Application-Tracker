        ...
        <div class="py-8">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="mb-3 text-right">
                    <a :href="'/application/edit/'+app.id" class="bg-indigo-500 text-white px-3 py-2  rounded hover:bg-indigo-700">{{ __('Edit') }}</a>
                    <a :href="'/applications'" class="bg-indigo-500 text-white px-3 py-2 rounded hover:bg-indigo-700">{{ __('Back') }}</a>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="container mx-auto p-4 divide-y divide-gray-200">
                        ...
                        <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                            ...
                            <div class="mt-2 px-6">
                                <span class="text-lg leading-7 text-gray-900 font-semibold">{{ __('Company') }}:</span> 
                                {{app.company}} 
                            </div>
                            <div class="mt-1 px-6">
                                <span class="text-lg leading-7 text-gray-900 font-semibold">{{ __('Location') }}:</span> 
                                {{app.location}}
                            </div>
                			<div class="mt-1 px-6">
                                <span class="text-lg leading-7 text-gray-900 font-semibold">{{ __('Post Title') }}:</span> 
                                {{app.post_title}}
                            </div>
                            ...
                            <div class="grid grid-cols-1">
                                <div class="p-6">
                                    <div class="flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" width="30px" height="25px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">
                                        ...
                                        <div class="ml-4 text-lg leading-7 text-gray-900 font-semibold">{{ __('Link') }}: </div>
                                        <a :href=app.link target="_blank" class="underline text-teal-900 dark:text-white ml-1">{{app.link}}</a>
                                    </div>
                            ...
                            <div class="grid grid-cols-1">
                                <div class="p-6">
                                    ...
                                    <div class="ml-12">
                                        ...
                                        <div class="inline-block text-gray-700 text-sm text-center bg-gray-100 rounded-full border-b border-r border-gray-600 px-3 py-1 "><b>{{ __('Email') }}:</b> 
                                            {{app.email}} 
                                        </div>
                                        <div class="inline-block text-gray-700 text-sm text-center bg-gray-100 rounded-full border-b border-r border-gray-600 px-3 py-1 "><b>{{ __('Phone') }}:</b> 
                                            {{app.phone}} 
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="w-full  mx-left py-8">
                         <div class="shadow-md">
                            <div class="tab w-full overflow-hidden border-t">
                               ...
                               <label class="block p-5 leading-normal cursor-pointer text-red-800" for="tab-multi-one">{{ __('Delete Application') }}</label>
                               <div class="tab-content overflow-hidden border-l-2  border-red-300 leading-normal">
                                    <p class="p-5">
                                        {{ __('This action is irreversible') }}.<br/>
                                        {{ __('Delete this item') }}?
                                    </p>
                                    <form @submit.prevent="submit" method="POST">
                                        <button type="submit" class="m-5 px-5 py-3 rounded text-white bg-red-800 hover:bg-red-700 border-red-900">{{ __('Delete') }}</button>
                                    </form>
                               </div>
                            </div>
                         </div>
