        ...
        <div class="py-8">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="mb-2 text-right">
                    <a :href="'/applications'" class="bg-indigo-500 text-white px-2 py-1  rounded hover:bg-indigo-700">{{ __('Back') }}</a>
                </div>
                            ...
                            <div class="grid grid-cols-1">
                                <div class="p-6">
                                    <div class="flex items-center">
                                        ...
                                        <input v-model="appData.link" class="shadow appearance-none border rounded w-full ml-4 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="link" type="text" v-bind:placeholder="__('Post URL')">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="ml-12">
                                        <div class="md:flex md:items-center mb-3 mt-2">
                                            <div class="w-full px-3 max-w-lg">
                                              ...
                                              <input v-model="appData.contactPerson" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="contactPerson" type="text" v-bind:placeholder="__('Full Name')">
                                            </div>
                                        </div>
                                        <div class="md:flex md:items-center mb-3 max-w-lg">
                                            ...
                                            <div class="w-full md:w-1/2 px-3">
                                              ...
                                              <input v-model="appData.phone" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="phone" type="tel" v-bind:placeholder="__('phone number')">
                                            </div>
                                        </div>
                        ...
                        <div class="mt-6 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                            <div class="grid grid-cols-1">
                                <div class="p-6">
                                    ...
                                    <div class="ml-12">
                                        <input v-model="appData.sent_files" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="sent_files" type="text" v-bind:placeholder="__('The files you sent : CV, motivation letter etc.')">
                                    </div>
                                </div>
                            </div>
                            <div class="grid grid-cols-1">
