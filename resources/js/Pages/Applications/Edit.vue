                        ...
                        <div class="mt-6 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                            <div class="mt-2 p-4">
                                <div class="md:flex md:items-center mb-3 mt-2">
                                    <div class="w-full px-3 max-w-lg">
                                      ...
                                      <input v-model="appData.company" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="company" type="text" placeholder="Company Name">
                                ...
                                <div class="md:flex md:items-center mb-3">
                                    <div class="w-full px-3 max-w-lg">
                                      ...
                                      <input v-model="appData.location" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="location" type="text" placeholder="Location">
                                    </div>
                                </div>
                                <div class="md:flex md:items-center mb-3">
                                    <div class="w-full px-3">
                                      ...
                                      <input v-model="appData.post_title" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="post_title" type="text" placeholder="Title">
                            ...
                            <div class="grid grid-cols-1">
                                <div class="p-6">
                                    <div class="flex items-center">
                                        ...
                                        <input v-model="appData.link" class="shadow appearance-none border rounded w-full ml-4 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="link" type="text" placeholder="Post URL">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1">
                                <div class="p-6">
                                    ...
                                    <div class="ml-12">
                                        <textarea v-model="appData.description" class="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none" rows="4"></textarea>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="ml-12">
                                        <div class="md:flex md:items-center mb-3 mt-2">
                                            <div class="w-full px-3 max-w-lg">
                                              ...
                                              <input v-model="appData.contactPerson" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="contactPerson" type="text" placeholder="Full Name">
                                            </div>
                                        </div>
                        ...
                        <div class="mt-6 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                            <div class="grid grid-cols-1">
                                <div class="p-6">
                                    ...
                                    <div class="ml-12">
                                        <input v-model="appData.sent_files" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="sent_files" type="text" placeholder="The files you sent : CV, letter etc">
                                    </div>
                                </div>
                            </div>
                            <div class="grid grid-cols-1">
                                <div class="p-6">
                                    ...
                                    <div class="ml-12">
                                        <textarea v-model="appData.motivation_letter" class="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none" rows="4"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="grid grid-cols-1">
                                <div class="p-6">
                                    ...
                                    <div class="ml-12">
                                        <textarea v-model="appData.comment" class="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none" rows="4"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
