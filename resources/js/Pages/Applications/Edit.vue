                                ...
                                <div class="mt-2">
                                    ...
                                    <div class="md:flex md:items-center mb-3">
                                        <div class="w-full px-3">
                                          ...
                                          <input v-model="appData.link" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="link" type="text" placeholder="URL">
                                        </div>
                                    </div>
